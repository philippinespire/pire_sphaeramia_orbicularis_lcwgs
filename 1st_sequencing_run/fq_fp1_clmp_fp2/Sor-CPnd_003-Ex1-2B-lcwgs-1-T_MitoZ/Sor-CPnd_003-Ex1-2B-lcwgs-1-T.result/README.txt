...
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T_mitoscaf.fa.val
errorsummary.val
...
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T.fasta
...
the file Sor-CPnd_003-Ex1-2B-lcwgs-1-T_mitoscaf.fa.gbf has no annotation problem.
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T_mitoscaf.fa.tbl
...
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T.cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T.rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T.trna

- 11. The control region sequence.
File:
Sor-CPnd_003-Ex1-2B-lcwgs-1-T.misc_feature
