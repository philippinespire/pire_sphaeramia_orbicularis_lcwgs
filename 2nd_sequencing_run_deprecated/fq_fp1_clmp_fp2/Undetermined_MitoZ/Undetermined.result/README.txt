...
the file Undetermined_mitoscaf.fa.gbf has no annotation problem.
File:
Undetermined_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Undetermined_mitoscaf.fa.tbl
