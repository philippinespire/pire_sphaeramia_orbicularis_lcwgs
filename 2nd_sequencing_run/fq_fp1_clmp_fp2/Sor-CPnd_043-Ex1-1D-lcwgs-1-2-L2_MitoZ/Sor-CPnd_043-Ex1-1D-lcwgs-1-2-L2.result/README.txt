...
File:
errorsummary.val
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2_mitoscaf.fa.val
...
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2.fasta
...
the file Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2_mitoscaf.fa.gbf has no annotation problem.
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2_mitoscaf.fa.tbl
...
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2.cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2.rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2.trna

- 11. The control region sequence.
File:
Sor-CPnd_043-Ex1-1D-lcwgs-1-2-L2.misc_feature
