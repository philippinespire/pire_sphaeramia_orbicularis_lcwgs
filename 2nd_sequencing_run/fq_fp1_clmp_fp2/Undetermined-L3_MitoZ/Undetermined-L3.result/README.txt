...
File:
Undetermined-L3_mitoscaf.fa.val
errorsummary.val
...
File:
Undetermined-L3_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Undetermined-L3.fasta
...
the file Undetermined-L3_mitoscaf.fa.gbf has no annotation problem.
File:
Undetermined-L3_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Undetermined-L3_mitoscaf.fa.tbl
