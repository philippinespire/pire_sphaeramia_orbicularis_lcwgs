...
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2_mitoscaf.fa.val
errorsummary.val
...
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2.fasta
...
the file Sor-CPnd_016-Ex1-1B-lcwgs-1-2_mitoscaf.fa.gbf has no annotation problem.
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2_mitoscaf.fa.tbl
...
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2.cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2.rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2.trna

- 11. The control region sequence.
File:
Sor-CPnd_016-Ex1-1B-lcwgs-1-2.misc_feature
