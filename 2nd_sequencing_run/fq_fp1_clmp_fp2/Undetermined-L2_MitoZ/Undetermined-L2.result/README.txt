...
File:
Undetermined-L2_mitoscaf.fa.val
errorsummary.val
...
File:
Undetermined-L2_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Undetermined-L2.fasta
...
the file Undetermined-L2_mitoscaf.fa.gbf has no annotation problem.
File:
Undetermined-L2_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Undetermined-L2_mitoscaf.fa.tbl
