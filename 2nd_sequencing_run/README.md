...
<details><summary>17. Extract mitochondrial genomes from read data</summary>

## 17. Extract mitochondrial genomes from read data
...
```
* The `runMitoZ_array.bash` and `runMitoZ_array.sbatch` scripts need to be altered before running. Using nano I found every instance of `_clmp.fp2_r1.fq.gz` and replaced it with `-clmp.fp2_r1.fq.gz`.
...
Sor-ACeb_009-Ex1-4F-lcwgs-1-2-L2
Sor-ACeb_009-Ex1-4F-lcwgs-1-2-L3
...
Sor-ACeb_015-Ex1-10F-lcwgs-1-2-L2
...
Sor-ACeb_022-Ex1-5G-lcwgs-1-2-L2
